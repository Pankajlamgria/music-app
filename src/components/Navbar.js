    ...
    <div>
      ...
      {/* <audio id="sogplay" src="https://firebasestorage.googleapis.com/v0/b/imageuploadingtester.appspot.com/o/songs%2Fimg1?alt=media&token=0395011e-be1f-4ba0-9978-4d91b4f12ed8" ></audio> */}
        ...
        <ul type="none" className="navbarlink" id="firstul">
          ...
          <li>
            <img className="navbaricon" src={searchimg} alt="" /><Link to="/" style={{color:(active.check===2)?("white"):("rgb(206, 206, 206)")}} onClick={()=>{setactive({check:2})}}>Search</Link>
          </li>
        </ul>
        <hr style={{color:"white"}} />
        <ul type="none" className="navbarlink" > 
        <li>
            <img className="navbaricon" src={favourite} alt="" /><Link to="/" style={{color:(active.check===3)?("white"):("rgb(206, 206, 206)")}} onClick={()=>{setactive({check:3})}}>Favourite</Link>
          </li>
        </ul>
      </div>
    </div>
